...
This folder contains my **Analogy** notes, concepts, types of relationships, methods, and practice questions.
...
### Basic Concept
- Analogy means **similarity / relationship**
- Analogy questions can be based on:
  - Words
  - Letters
  - Numbers
  - Figures
...
4. Animal and their respective Young One
5. Male and Female
6. Individual and Class
7. Individual and Living Place
8. Study and Topic
9. Tool and Action
...
20. Country and Currency
21. Animal and Movement
22. Animal and Thing and Sound
...
- Anemometer : Wind
- Odometer : Speed / Distance Travelled
- Hygrometer : Humidity
- Balance : Mass
- Ruler : Length
- Ammeter : Current
...
The blank may be on either the left or right side.

### 3. Statement Based

Identify the relationship between the first pair and apply the same relationship to the second pair.
...
Identify the relationship first and apply the same relationship.
...
Build a strong understanding of **Analogy** by learning different types of relationships and applying the same relationship to new word, number, letter, and concept pairs.
